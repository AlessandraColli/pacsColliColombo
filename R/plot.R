...
#' 
#' @param x A mesh.2D object defining the triangular mesh, as generated by \code{create.mesh.2D} or \code{refine.mesh.2D}.
...
plot.mesh.3D<-function(mesh,...){
 ...
 #' @usage \method{image}{FEM}{2D}(x, num_refinements, ...)  
